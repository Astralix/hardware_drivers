...
#define DP52_AUX_MUX_VILED 			(0x0)
#define DP52_AUX_MUX_VCC 			(0x1)
#define DP52_AUX_MUX_VIBAT 			(0x2)
...
#define DP52_AUX_MUX_LED			(0x10)
#define DP52_AUX_MUX_VDD			(0x11)
#define DP52_AUX_MUX_VIBAT_ATT 		(0x12)
#define DP52_AUX_MUX_TEMP0_DIFF		(0x13)
#define DP52_AUX_MUX_TEMP1_DIFF 	(0x14)
#define DP52_AUX_MUX_TEMP2_DIFF 	(0x15)
...
typedef  int (*irq_handler)( void*, int );

int 	dp52_deregister_irqhandler( int type );
int 	dp52_register_irqhandler( int type, irq_handler irq );
int 	dp52_direct_write( unsigned int reg, unsigned int value );
int 	dp52_direct_read( unsigned int reg );
int 	dp52_direct_read_modify_write(unsigned int reg, int mask, int val);
int 	dp52_indirect_read( unsigned int reg );
int 	dp52_indirect_write( unsigned int reg, unsigned int value );
int 	dp52_aux_read( unsigned int mux );
int 	dp52_init_modul( int modul );
void 	dp52_disable_irq( int mask );
void	dp52_enable_irq( int mask );
int		tsc_dp52_read_values( struct tsc_dp52_measure* pvalues);


void tsc_dp52_bypass_init( void );
