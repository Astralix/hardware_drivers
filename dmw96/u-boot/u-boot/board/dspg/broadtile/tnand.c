 ...
 */
static int tnand_id(int argc, char *argv[])
{
...
static int tnand_onfi(int argc, char *argv[])
{
	struct mtd_info *mtd = &nand_info[nand_curr_device];
	struct nand_chip *chip = mtd->priv;
...
static int tnand_biterr(int argc, char *argv[])
{
	struct mtd_info *mtd = &nand_info[nand_curr_device];
	loff_t off;
...
static int tnand_ecc(int argc, char *argv[])
{
	struct mtd_info *mtd = &nand_info[nand_curr_device];
	int use_ecc;
...
static int tnand_ecc_mode(int argc, char *argv[])
{
	struct mtd_info *mtd = &nand_info[nand_curr_device];
	int ecc_mode;
...
static int tnand_get_oob_config(int argc, char *argv[])
{
	struct mtd_info *mtd = &nand_info[nand_curr_device];
	struct nand_chip *chip = mtd->priv;
...
static int tnand_ecc_test(int argc, char *argv[])
{
	struct mtd_info *mtd = &nand_info[nand_curr_device];
	struct nand_chip *chip = mtd->priv;
	struct dmw96_nfc_info *info = chip->priv;
...
static int tnand_ecc_test2(int argc, char *argv[])
{
	struct mtd_info *mtd = &nand_info[nand_curr_device];
	struct nand_chip *chip = mtd->priv;
	struct dmw96_nfc_info *info = chip->priv;
...
static int tnand_write_read_test(int argc, char *argv[])
{
	struct mtd_info *mtd = &nand_info[nand_curr_device];
	nand_erase_options_t e_opts;
	int ret = 0;
...
static int tnand_check_erased(int argc, char *argv[])
{
	struct mtd_info *mtd = &nand_info[nand_curr_device];
	uint8_t *pagebuf;
	uint8_t *pagebuf2;
...
static int tnand_isbad(int argc, char *argv[])
{
	struct mtd_info *mtd = &nand_info[nand_curr_device];
	unsigned long addr;
...
int do_tnand(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	int res = 1;
