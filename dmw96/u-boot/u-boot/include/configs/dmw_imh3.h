...
/* define board type */
#define DMW_BOARD_IMH3
#define CONFIG_DMW_BOARDID "imh3"
...
/* default lcd */
#define CONFIG_DMW_LCDCTYPE "amoled"
...
/* Rear Camera GPIO mappig */
#define CONFIG_DMW_GPIO_CAM_REAR_RESET				(FGPIO(22))
#define CONFIG_DMW_GPIO_CAM_REAR_PWDN				(FGPIO(11))
#define CONFIG_DMW_GPIO_CAM_REAR_PWDN_AUTO_FUCUS	(GGPIO(27))
