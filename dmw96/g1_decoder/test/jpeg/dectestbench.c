		...
		if(foutput && pYuvOutChroma)
		{
			...
			if(!progressive)
			{
				if(!planarOutput)
				{
					...
					{
						fwrite(pYuvOutChroma + (4 * i) + 0, sizeof(u8), 1, foutput);
						fwrite(pYuvOutChroma + (4 * i) + 1, sizeof(u8), 1, foutput);
						fwrite(pYuvOutChroma + (4 * i) + 2, sizeof(u8), 1, foutput);
						fwrite(pYuvOutChroma + (4 * i) + 3, sizeof(u8), 1, foutput);
					}
				}
				else
				{
					for(i = 0; i < chromaLen / 2; i++)
						fwrite(pYuvOutChroma + 2 * i, sizeof(u8), 1, foutput);
					for(i = 0; i < chromaLen / 2; i++)
						fwrite(pYuvOutChroma + 2 * i + 1, sizeof(u8), 1, foutput);
				}
			}
			else
			{
				...
				else
				{
					...
					for(i = 0; i < chromaLen; i++)
						fwrite(pYuvOutChroma + i, sizeof(u8), 1, foutput);
				}
			}
		}
		fclose(foutput);
