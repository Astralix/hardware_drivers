...
#ifndef ON2_OMX_PLUGIN_H_

#define ON2_OMX_PLUGIN_H_

#include <media/stagefright/OMXPluginBase.h>

namespace android {

struct ON2OMXPlugin : public OMXPluginBase {
    ON2OMXPlugin();
    virtual ~ON2OMXPlugin();
...
private:
    ...
    ON2OMXPlugin(const ON2OMXPlugin &);
    ON2OMXPlugin &operator=(const ON2OMXPlugin &);
};

}  // namespace android

#endif  // ON2_OMX_PLUGIN_H_
