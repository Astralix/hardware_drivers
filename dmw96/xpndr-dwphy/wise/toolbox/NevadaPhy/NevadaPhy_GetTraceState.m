function [S,Y] = NevadaPhy_GetTraceState
% [S,Y] = NevadaPhy_GetTraceState;
%         Retrieve trace and state data from NevadaPHY, radio, and Nevada models

S  = wiseMex('Nevada_GetRxState()');
...
S2 = wiseMex('NevadaPhy_GetState()');
S.RX.sRX0 = S2.sRX0;
S.TX = wiseMex('Nevada_GetTxState()');
clear S2;
S2 = wiseMex('bNevada_GetRxState()');
if S.EnableTrace,
...
clear S2;
try
    S.Radio = wiseMex('Radio_GetRxState()');
catch
    S.Radio = wiseMex('RF55_GetRxState()');
end
