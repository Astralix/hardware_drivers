function [S,Fs,Prms,TxData] = wiPHY_TX(DataRate, TxData)
...
%
% Note: Some PHY implementations may override the specified DataRate if
% some other means is used to configure the modulation and code rate.
