...
//
    ...
    static dwPhyRegPair_t DefaultReg_Mojave_RF22A12[] = 
    {
        ...
        {0x00ED,0x85}, {0x0102,0x00}, {0x0103,0x00}, {0x0104,0x00}, {0x010f5,0x02}, {0x0106,0x00}, {0x0107,0x00}, {0x0108,0x40}, 
...
//        {0x0112,0x00}, {0x0113,0x00}, {0x0114,0x88}, {0x0115,0x41}, {0x0116,0x00}, {0x0117,0x18}, {0x0118,0x23}, {0x0119,0x00}, 
        {0x0112,0x00}, {0x0113,0x00}, {0x0114,0x88}, {0x0115,0x35}, {0x0116,0x00}, {0x0117,0x18}, {0x0118,0x23}, {0x0119,0x00}, 
    ...
    //               Reg0x8039 = 0xff          
    //               Reg0x803B = 0x80 CURVE_HIGH_THRESHOLD =  511 (was 420)
    //               Reg0x803A = 0x00 CURVE_LOW_THRESHOLD  =  0   (was 110)
    ...
    static dwPhyRegPair_t DefaultReg_Nevada_RF22B0[] = 
    {
		...
		{0x010A,0x00}, {0x010B,0x00}, {0x010C,0x07}, {0x010D,0x00}, {0x010E,0x00}, {0x010F,0x5A}, {0x0110,0x95}, {0x0111,0x00}, 
	    {0x0112,0x00}, {0x0113,0x00}, {0x0114,0x88}, {0x0115,0x46}, {0x0116,0x00}, {0x0117,0x18}, {0x0118,0x23}, {0x0119,0x00}, //NEW
        //{0x0112,0x00}, {0x0113,0x00}, {0x0114,0x88}, {0x0115,0x5b}, {0x0116,0x00}, {0x0117,0x18}, {0x0118,0x23}, {0x0119,0x00}, //OLD
		...
		{0x012A,0x3F}, {0x012B,0x0D}, {0x012C,0x00}, {0x012D,0x40}, {0x012E,0x00}, {0x012F,0x43}, {0x0130,0x00}, {0x0131,0x40}, 
		{0x0132,0xC3}, {0x0133,0x1E}, {0x0134,0x1E}, {0x0135,0x28}, {0x0136,0x1E}, {0x0137,0x00}, {0x0138,0x00}, {0x0139,0x00}, 
		{0x013A,0x00}, {0x013B,0x00}, {0x013C,0x78}, {0x013D,0x40}, {0x013E,0x00}, {0x013F,0x00}, {0x0140,0x70}, {0x0141,0x00}, 
		{0x0142,0xF0}, {0x0143,0x00}, {0x0144,0x00}, {0x0145,0x00}, {0x0146,0x0C}, {0x0147,0x00}, {0x0148,0x00}, {0x0149,0x46}, 
		{0x014A,0x44}, {0x014B,0x00}, {0x014C,0x71}, {0x014D,0x08}, {0x014E,0x1B}, {0x014F,0x11}, {0x0150,0x02}, {0x0151,0x11}, 
		{0x0152,0x1B}, {0x0153,0x9D}, {0x0154,0x13}, {0x0155,0x02}, {0x0156,0x40}, {0x0157,0x9D}, {0x0158,0x00}, {0x0159,0x00}, 
		{0x015A,0x00}, {0x015B,0x0C}, {0x015C,0x00}, {0x015D,0x00}, {0x015E,0x08}, {0x015F,0x00}, {0x0160,0x90}, {0x0161,0x00}, 
		{0x0162,0x00}, {0x0163,0x01}, {0x0164,0x00}, {0x0165,0x00}, {0x0166,0x00}, {0x0167,0x03}, {0x0168,0x24}, {0x0169,0xB2}, 
		{0x016A,0xA0}, {0x016B,0x20}, {0x016C,0x73}, {0x016D,0x73}, {0x016E,0x04}, {0x016F,0x01}, {0x0170,0x27}, {0x0171,0x1C}, 
		{0x0172,0x0F}, {0x0173,0xC0}, {0x0174,0x00}, {0x0175,0x00}, {0x0176,0x30}, {0x0177,0x01}, {0x0178,0x78}, {0x0179,0x3C}, 
	  ...
	  //{0x8032,0x33}, {0x8033,0x36}, {0x8034,0x82}, {0x8035,0x30}, {0x8036,0x80}, {0x8037,0x08}, {0x8038,0x00}, {0x8039,0xD2},//OLD 
	    {0x8032,0x33}, {0x8033,0x36}, {0x8034,0x82}, {0x8035,0x30}, {0x8036,0x80}, {0x8037,0x08}, {0x8038,0x00}, {0x8039,0xff},//NEW 
	  //{0x803A,0x6E}, {0x803B,0x00}, {0x803C,0x00}, {0x803D,0x00}, {0x803E,0x1F}, {0x803F,0x51}, {0x8040,0x76}, {0x8041,0x0B},//OLD 
        {0x803A,0x00}, {0x803B,0x80}, {0x803C,0x00}, {0x803D,0x00}, {0x803E,0x1F}, {0x803F,0x51}, {0x8040,0x76}, {0x8041,0x0B},//NEW
		{0x8042,0x00}, {0x8043,0x00}, {0x8044,0x03}, {0x8045,0x0E}, {0x8046,0x17}, {0x8047,0x22}, {0x8048,0x2D}, {0x8049,0x00}, 
		{0x804A,0x01}, {0x804B,0xA2}, {0x804C,0x10}, {0x804D,0x18}, {0x804E,0x30}, {0x804F,0x2C}, {0x8050,0x4E}, {0x8051,0x8E}, 
		{0x8052,0xD6}, {0x8053,0x34}, {0x8054,0x72}, {0x8055,0x68}, {0x8056,0xB7}, {0x8057,0xF9}, {0x8058,0xFF}, {0x8059,0x06}, 
	  //{0x805A,0x00}, {0x805B,0x2E}, {0x805C,0x8D}, {0x805D,0x00}, {0x805E,0x82}, {0x805F,0x14}, {0x8060,0x03}, {0x8061,0x07},//OLD  Max Power = 23*2=46=0x2e -> 32768 - 128 + 219= 0x805B
        {0x805A,0x00}, {0x805B,0x20}, {0x805C,0x8D}, {0x805D,0x00}, {0x805E,0x82}, {0x805F,0x14}, {0x8060,0x03}, {0x8061,0x07},//New  Max Power = 16*2=32 = 0x20  
