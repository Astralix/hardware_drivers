...
//
    ...
    */
    //-------- To solve CCK spur issue ----------------------------------------------------------------------------------------
    //               Reg0x801A = 0x84 {was 0x82} CAL_VGA1 = 4	VGA1 value during IQ and LOFT calibrations.
    //               Reg0x0155 = 0x01 {was 0x02} ENVDETTH = 1	Overload comparator threshold, 1h - 1.0Vampdiff
    //--------- Disable the step down feature -------------------------------------------------------------------
    //               Reg0x00CE = 0x8B {was 0xCB} StepDownRestart  = 0   disable  RX restart on StepDown indicator
    //--------- To solve strong signal retries --------------------------------------------------------------------------------
    //               Reg0x0008 = 0x05 {was 0x08} aTxDelay = 5   Delay from MAC_TX_EN to the start of an OFDM packet.
    //                                                          The delay  is approximately (0.1μs)(TxDelay + 22).
    //               Reg0x0009 = 0x07 {was by default 0x14} bTxDelay
    //                                                          Delay from MAC_TX_EN to the start of a DSSS/CCK packet.
    //                                                          The delay is approximately (0.1μs)(TxDelay + 22).
    //-------------------------------------------------------------------------------------------------------------------------
	//--------- Removed:     same as default &  write to read only     
	//-------------------------------------------------------------------------------------------------------------------------
	//				 Reg0x00CE = 0xCB {was 0x8B} StepDownRestart = 1	Alow RX restart on StepDown  indication     BB
	//-------------------------------------------------------------------------------------------------------------------------
    static dwPhyRegPair_t DefaultReg_Nevada_RF22B0[] = 
    {
        {0x0003,0x02}, {0x0004,0x07}, {0x0005,0x00}, {0x0006,0x03}, {0x0007,0x00}, {0x0008,0x05}, {0x0009,0x07},
                                                                                                  {0x000A,0x00}, {0x000C,0x00},
        {0x000D,0x00}, {0x000E,0x7F}, {0x0018,0xFF}, {0x0019,0x0D}, {0x001A,0xFF}, {0x001B,0xFF}, {0x001C,0x26}, {0x001D,0xF8}, 
        {0x001E,0x43}, {0x001F,0x00}, {0x0020,0x0C}, {0x0021,0x17}, {0x0024,0x00}, {0x0025,0x00}, {0x0026,0x00}, {0x0027,0x00}, 
        {0x0028,0x00}, {0x0029,0x00}, {0x002A,0x00}, {0x002B,0x00}, {0x002C,0x00}, {0x002D,0x00}, {0x002E,0x00}, {0x0030,0x06}, 
        {0x0031,0x79}, {0x0032,0x04}, {0x0033,0xB4}, {0x0034,0x50}, {0x0035,0x18}, {0x0036,0x00}, {0x0037,0x00}, {0x003B,0x1C}, 
        ...
        {0x00F1,0x0F}, {0x00F2,0x30}, {0x00F3,0x28}, {0x00F4,0x20}, {0x00F5,0x18}, {0x00F6,0xC5}, {0x00F7,0xC5}, {0x00F8,0xA5}, 
		//Start RF
	    {0x0104,0xC0}, {0x0107,0x07}, {0x010C,0x07}, {0x010F,0x5A}, {0x0113,0x00}, {0x0114,0x88}, {0x0115,0x50}, {0x0118,0x23},
		{0x0119,0x00}, {0x011A,0x03}, {0x011C,0x13}, {0x011F,0xA1}, {0x0121,0x1A}, {0x0128,0x45}, {0x012D,0x42}, {0x012E,0x03},
		{0x012F,0x43}, {0x0131,0x40}, {0x0132,0xC3}, {0x0133,0x1E}, {0x0134,0x1E}, {0x0135,0x28}, {0x0136,0x1E}, {0x013C,0x78},
		{0x013D,0xC0}, {0x0142,DWPHY_VERSION},       {0x0143,0x00}, {0x014C,0x71}, {0x014D,0x08}, {0x014E,0x16}, {0x014F,0x16},
		{0x0150,0x02}, {0x0151,0x1F}, {0x0153,0x0F}, {0x0154,0xFD}, {0x0155,0x01}, {0x0156,0x40}, {0x0157,0x7F}, {0x015B,0x0C},
		{0x015E,0x08}, {0x0160,0x90}, {0x0163,0x00}, {0x0169,0x12}, {0x016A,0xA0}, {0x016C,0x73}, {0x016D,0x73}, {0x0170,0x27},
		{0x0171,0x1C}, {0x0172,0x0F}, {0x0173,0xC0}, {0x0175,0x80}, {0x0176,0x30}, {0x017A,0x14}, {0x017B,0x64}, {0x017C,0x3C},
		{0x017D,0x3F}, {0x017E,0x7F}, {0x017F,0x90},
		// indirect addressing 
		{0x8001,0xFA}, {0x8003,0x3F}, {0x8004,0x27}, {0x800B,0x13}, {0x800C,0x0F}, {0x800D,0x0E}, {0x801A,0x84}, {0x801B,0x12},
		{0x801C,0x8E}, {0x801D,0xA6}, {0x801F,0x93}, {0x8022,0xC8}, {0x8023,0xC8}, {0x8025,0xC8}, {0x802F,0x80}, {0x8030,0x80},
		{0x8034,0x82}, {0x8038,0x00}, {0x8039,0xFF}, {0x803A,0x4B}, {0x803D,0x00}, {0x803E,0x12}, {0x803F,0x21}, {0x8040,0x73},
		{0x8042,0x00}, {0x8043,0x00}, {0x8044,0x16}, {0x8045,0x1C}, {0x8046,0x28}, {0x8047,0x2D}, {0x8048,0x2F}, {0x804B,0xA2},
		{0x804D,0x18}, {0x804E,0x2F}, {0x804F,0x29}, {0x8050,0x47}, {0x8051,0x87}, {0x8052,0xCD}, {0x8053,0x30}, {0x8054,0x62},
		{0x8055,0x5F}, {0x8056,0x9E}, {0x8057,0xE6}, {0x8058,0xFF}, {0x8059,0x04}, {0x805B,0x27}, {0x805C,0xD8}, {0x805F,0x14},
		{0x8060,0x03}, {0x8061,0x07}, {0x8062,0xEC}, {0x8063,0x2A}, {0x806B,0xCB}, {0x806C,0xC2}, {0x8070,0x28}, {0x8074,0x0B},
		{0x807C,0xC2}, {0x807D,0xBC}, {0x807E,0x90}, {0x807F,0x90}

    }; // Updated 18-April-2012 18:32
    ...
    switch (Parameter)
    {
        ...
        case DWPHY_PARAM_CHIPSET_ALIAS:
        {
            ...
            switch (DataSize)
            {
                ...
                case 4:
                    ...
                    if (copy_from_user(Data, pUserData, DataSize) != 0)
        ...
        case DWPHY_PARAM_DEFAULTREGISTERS:
        {
            ...
            if (pDwPhy->DefaultRegLength > 0)
            {
                ...
                {
                    if (copy_from_user(pData, pUserData, DataSize) != 0)
                        status = DWPHY_ERROR_OSCOPYFROMUSER;
                    else
                    {
...
// ================================================================================================
static dwPhyStatus_t DwPhy_SetMaxLength(dwDevInfo_t *pDevInfo, uint32_t MaxLength)
{
    if (MaxLength > 4095) return DWPHY_ERROR_PARAMETER2; // out of range
    DwPhy_WriteReg( 24, (uint8_t)((MaxLength + 15)/16) );
...
dwPhyStatus_t DwPhy_Initialize(dwDevInfo_t *pDevInfo, dwPhyPlatform_t PlatformID)
{
    ...
    // Initialization
    // --------------
	//mexPrintf(" Initialization:  NumReg =   %d\n", NumReg);
    for (i=0; i<NumReg; i++) 
    {
...
dwPhyStatus_t DwPhy_Startup(dwDevInfo_t *pDevInfo)
{
    ...
    //
    memset(pDwPhy, 0, sizeof(DwPhy_t));
...
#endif
            DwPhy_WriteReg(RF_ADDR_OFFSET+21,(uint8_t)New_Refrostune);
        }
        else
        {
#ifdef DWPHY_DEBUG
...
// - Added copy_from_user calls to copy parameter data from user space to driver-safe memory
//
// Revised 2008-03-19
