///
/// @file    	SQLiteBinary.cpp
///
/// @brief		CSQLiteBinary class'  implementation
///
///				This type handles all r\w requests to binary data and stores buffers for data retreival.
///
/// @internal
///
...
CSQLiteBinary::CSQLiteBinary(Database* pDb, IError* pErr) :
						m_pDb(pDb),
...
void CSQLiteBinary::error(const char* strErrorMsg)
{
	m_pErrorHandler->error(*m_pDb, strErrorMsg);
}
