/*
 * Copyright(c) 2001 - 2011 DSP Group. All rights reserved.
 */
...
#define WIFI_BATCHTX_RATE_MCS_IDX 0x40
	...
	/// 0, 1, 2, 3, 4, 5, 6, 7 if WIFI_BATCHTX_RATE_MCS_IDX is set.
	uint8 phyRate;
...
WIFIAPI uint32 WifiMibAPI(void *deviceSelector,
			  mibObjectContainer_t * miboids, uint32 numMiboids);
...
#define MIBOID_DIVERSITYSUPPORT_MIN						WIFI_DIVERSITY_DEFAULT
#define MIBOID_DIVERSITYSUPPORT_MAX						WIFI_DIVERSITY_ANTENNA_AB

enum {
	WIFI_DIVERSITY_DEFAULT = 0,
	WIFI_DIVERSITY_ANTENNA_A = 1,
	WIFI_DIVERSITY_ANTENNA_B = 2,
	WIFI_DIVERSITY_ANTENNA_AB = 3
};
...
#define MIBOID_POWERMGMT_AUTO_TRIGGER_ATTRIB	(MIBOID_ATTRIB_READ | MIBOID_ATTRIB_WRITE | MIBOID_ATTRIB_MINMAX)
...
#define MIBOID_DBGBATCHTX_ATTRIB						(MIBOID_ATTRIB_READ | \
                                                        MIBOID_ATTRIB_WRITE)
...
#define WIFI_PACKET_API_80211_TXFLAGS_RESERVED_00		0x00000040
...
#define WIFI_PACKET_API_80211_TXFLAGS_FALLBACK_EVERY_OTHER_RETRY	0x00000200
	...
	/// specifies the phy rate for the packet.  The phy rate is specified lower
	/// than the minPhyDataRate then minPhyDataRate will be used.  If fallback
	/// is enabled, the packet will go out at phyDataRate, but may fallback to
	/// as low as minPhyDataRate.  Valid values to be used for this field for
	/// 802.11a are: 6, 9, 12, 18, 24, 36, 48, 54.  Valid values to be used for
	/// this field for 802.11g are: 1, 2, 55, 6, 9, 11, 12, 18, 24, 36, 48, 54.
	/// Valid values to be used for this field for 802.11b are: 1, 2, 55, 11.
	/// Valid valies to be used for this field for 802.11n are: 0, 1, 2, 3, 4,
	/// 5, 6, 7
	uint8 phyDataRate;
	...
	/// Specifies the qos stream to which this packet belongs.  The
	/// wifiQosAPIHandle is passed to the user in a wifiQosAPI function call.
	/// Normally, the driver determines the correct queue to use based on the
	/// MAC address and the TID in the qos control field if it is present.
	/// This handle overrides that and allows the user to specify the qos
	/// stream to use, regardless of the MAC address or TID.
	///
	/// NOTE:  If the descriptorHeadPointer is also specified it will override
	/// this handle.
...
#define WIFI_PACKET_API_80211_RXFLAGS_MCS_INDEX		0x00000400
	...
	/// Valid values to be used for this field for 802.11a are: 6, 9, 12, 18,
	/// 24, 36, 48, 54.
	///
	/// Valid values to be used for this field for 802.11g are: 1, 2, 55, 6, 9,
	/// 11, 12, 18, 24, 36, 48, 54.
	///
	/// Valid values to be used for this field for 802.11b are: 1, 2, 55, 11
	/// 
	/// Valid values to be used for this field for 802.11n are: 0, 1, 2, 3,
	/// 4, 5, 6, 7
	uint8 phyDataRate;
...
WIFIAPI uint32 Wifi80211APISendPkt(void *device,
				   TX_WIFI_PACKET_DESC * wifiPacket);
...
/// @retval WIFI_DEVICE_NOT_FOUND
/// @retval WIFI_INVALID_PARAMS
WIFIAPI uint32 Wifi80211APIReceivePkt(void *device,
