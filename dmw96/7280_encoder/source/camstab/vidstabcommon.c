...
void VSReadStabData(const u32 * regMirror, HWStabData * hwStabData)
{
    ...
    hwStabData->rMotionSum = regMirror[40] & ((1 << 30) - 1);
    hwStabData->rMotionMin = (regMirror[41] >> 12) & ((1 << 20) - 1);

    hwStabData->rGmvX = ((i32) (regMirror[41] << 20) >> 26);
    hwStabData->rGmvY = ((i32) (regMirror[41] << 26) >> 26);
