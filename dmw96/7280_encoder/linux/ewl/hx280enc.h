...
#define HX280ENC_IOC_ENC_LOCK      _IO(HX280ENC_IOC_MAGIC, 9)
#define HX280ENC_IOC_ENC_UNLOCK    _IO(HX280ENC_IOC_MAGIC, 10)
#define HX280ENC_IOC_WAIT_ENC      _IO(HX280ENC_IOC_MAGIC, 11)

#define HX280ENC_IOC_MAXNR 11
